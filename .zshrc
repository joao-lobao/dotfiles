...
alias cpconfig="cp ~/.zshrc ~/Desktop/dotfiles/.zshrc && cp ~/.tmux.conf ~/Desktop/dotfiles/tmux/ && cp -r ~/.tmux/plugins/tmux/scripts ~/Desktop/dotfiles/tmux/.tmux/plugins/tmux"
