...
alias cpvim="cp ~/.zshrc ~/Desktop/dotfiles/.zshrc && cp -r ~/.config/nvim ~/Desktop/dotfiles && cp -r ~/.config/nvim-with-lsp ~/Desktop/dotfiles && cp ~/.config/nvim/coc-settings.json ~/Desktop/dotfiles"
